$(document).ready(function() {   
    ...
    //  REFERENCIAR EL BOTON CREAR producto
        const   $btnCrearCategoria= document.querySelector("#boton_crear_categoria");
                    ...
                    //  AJAX
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if(response.mensaje_creacion_categoria != ""){
                                    if(response.mensaje_creacion_categoria=="ok"){
                                        ...
                                        swa2_campo_obligatorio(response.mensaje_creacion_categoria);
                                    }
                                }                                
                            },// \.success
                        });
