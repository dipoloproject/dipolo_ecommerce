	...
	<![endif]-->
        ...
        <div class="body-wrapper">
            ...
            <header>
                ...
                <div class="header-bottom header-sticky d-none d-lg-block d-xl-block" style="margin-bottom: 0px;">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12" ">
                                ...
                                <div class="hb-menu">
                                    <nav>
                                        <ul>
                                            ...
                                            <li class="megamenu-static-holder"><a href="index.html">CATEGORÍAS</a>
                                                <ul class="megamenu hb-megamenu">
                ...
                <div class="banner_y_slider-contenedor">
                    <div>
                        <!-- Animacion slider infinito con las Marcas -->
                        <div class="contenedor_slider-marcas">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="{{route('producto_singular',['id' => 2])}}">
                                                    <img src="storage/archivos_multimedia/65440a070d115_0.jpg" alt="Li's Product Image">
                                                </a>
