<?php
    ...
    //echo "<pre>";var_dump($producto[0]->nombreArchivosMultimedia);exit;
    //echo "<pre>";var_dump($producto[0]->nombreArchivosMultimedia);exit;
    
    $array_mediafiles_names= explode(";", $producto[0]->nombreArchivosMultimedia);  //echo "<pre>";var_dump($array_mediafiles_names);exit;
...
@include ('templates/header')
	...
	<![endif]-->
        ...
        <div class="body-wrapper">
            <!-- Begin Header Area -->
            <header>
                @include ('templates/telephone_whatsapp_email')
                           ...
                           <!-- Product Details Left -->
                            <div class="product-details-left">
                                <div class="product-details-images slider-navigation-1">
                                    <?php
                                        foreach($array_mediafiles_names as $mediafile_name ):
                                    ?>
                                            <div class="lg-image">
                                                <img src="../../storage/archivos_multimedia/{{$mediafile_name}}" alt="product image" width="470px;" height="470px;">
                                            </div>
                                    <?php
                                        endforeach;
                                    ?>
                                ...
                                <div class="product-details-thumbs slider-thumbs-1">
                                    <!-- la visualizacion de este carrousel está en resources/js/main.js -->
                                    <?php
                                        foreach($array_mediafiles_names as $mediafile_name ):
                                    ?>
                                            <div class="sm-image">
                                                <img src="../../storage/archivos_multimedia/{{$mediafile_name}}" alt="product image thumb" width="118px;" height="118px;">
                                            </div>
                                    <?php
                                        endforeach;
                                    ?>
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="single-add-to-cart">
                                        <form action="#" class="cart-quantity">
                                            <button class="add-to-cart" type="submit">Add to cartasdfasfd</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
