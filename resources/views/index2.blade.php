...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="adminlte2/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="adminlte2/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="adminlte2/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="adminlte2/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview">
			<a href="#">
				<i class="fa fa-shield fa-lg" style="color:#f39c12;"></i>
				<span style="font-size:18px;">Permisos</span>
				<span class="pull-right-container">
					<i class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
		...
		<li class="treeview">
			<a href="#">
				<i class="fa fa-archive fa-lg" style="color:#00e676;"></i>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="adminlte2/dist/img/user4-128x128.jpg" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="adminlte2/dist/img/user3-128x128.jpg" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="adminlte2/dist/img/user2-160x160.jpg" alt="user image" class="offline">
...
<!-- Morris.js charts -->
<script src="adminlte2/bower_components/raphael/raphael.min.js"></script>
<script src="adminlte2/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
...
<!-- jQuery Knob Chart -->
<script src="adminlte2/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
